...
The current aligned workspace release line is `3.12.0` for:
...
- Minor release update: aligns the package line on `3.12.0` across the four NuGet-published libraries plus the `ImgSeeder`/`iorg` and `PitSeeder` CLIs.
