...
Then, find the next release number available across all 6 projects and change the csproj file's version number accordingly - all with one number (i.e. v3.12.0).
...
scripts/release-chain.sh 3.12.0</code>
