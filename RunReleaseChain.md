...
Then, find the next coordinated release number available across all 6 projects and change the csproj file's version number accordingly with one shared version (for example the next minor line `v3.13.0`).
