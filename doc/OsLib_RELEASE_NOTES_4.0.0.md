...
- [`CR003_RAI_to_RAIkeep_JsonPit-concurrency-contract-and-persistence-races.md`](CR003_RAI_to_RAIkeep_JsonPit-concurrency-contract-and-persistence-races.md) — OsLib share of the coordinated v4.0.0 concurrency work (agreed `TextFile.Save` contract, canonical JSON, `EventFile`/`EventDirectory`).
