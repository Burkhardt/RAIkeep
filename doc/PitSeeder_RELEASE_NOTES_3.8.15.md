# PitSeeder 3.8.15 Release Notes

## Summary

- Releases `PitSeeder` version `3.8.15`.
- Aligns CLI package metadata and fallback package references to `JsonPit 3.8.15` and `OsLibCore 3.8.15`.
